 ...
 */
package fr.insa.dhee.m3.projet.moveinsa.Session;
...
import fr.insa.dhee.m3.projet.moveinsa.model.GestionBdD;
...
public class SessionInfo implements Serializable {
     ...
     * @throws fr.insa.dhee.m3.projet.moveinsa.Session.SessionInfo.SessionException
     */
    ...
    public static Connection getOrCreateConnectionToBdD() throws SQLException {
        ...
        if (curI.conBDD == null) {
            curI.conBDD = GestionBdD.defaultCon();
        }
        return curI.conBDD;
    }
